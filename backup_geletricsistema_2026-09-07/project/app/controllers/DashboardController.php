...
class DashboardController {
    public function index(): void {
        ...
        $nextMonth = $nextRow['month'] ?? date('Y-m-01', strtotime('+1 month'));
        $nextRow['saida'] += $rec->totalActiveNotGeneratedForMonth($nextMonth);
        $nextRow['balanco']=$nextRow['entrada']-$nextRow['saida'];
